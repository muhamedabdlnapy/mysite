...
<head>
  <title>muhamedabdelnapy| Home Portfolio</title>
          ...
          <div class="col-md-7 header-right">
            ...
            <div class="hero__links">
              ...
              <ul class="hero__social">
                ...
                <li>
                  <a href="https://www.linkedin.com/in/muhamed-ahmed-7b5ba41b1/" rel="noopener" title='LinkedIn' target="_blank">
                    <svg version="1.1" width="1792" height="1792" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
            ...
            <ul class="address">
              ...
              <li>
                <ul class="address-text">
                  <li><b>E-MAIL </b></li>
                  <li><a href="mailto:muhamedabdelnapy|@gmail.com"> muhamedabdelnapy@gmail.com</a></li>
                </ul>
              </li>
              <li>
                <ul class="address-text">
                  <li><b>WEBSITE </b></li>
                  <li><a href="https://github.com/muhamedabdlnapy">GitHub</a></li>
                </ul>
              </li>
      ...
      <div id="owl-demo1" class="owl-carousel owl-carousel2">
        ...
        <div class="item">
          <div class="about-left-grid">
            ...
            <p>I've completed my,
              <P>
                <p>Computer Science   from Faculty of computer and information, Suez University.</a>,
  ...
  <div class="footer" id="contact">
    <div class="container">
        ...
        <div class="col-md-6 mail_left">
          <div class="contact-grid1-left">
            <div class="contact-grid1-left1">
              ...
              <ul>
                <li>Primary: <a href="mailto:muhamedabdlnapy@gmail.com">muhamedabdlnapy@gmail.com</a></li>
                <li>
      ...
      <div class="copy_right text-center">
        <p class="float-left">&copy;  Profile of MUHAMED AHMED ABDELNAPY</p>
        ...
        <ul class="hero__social">
          ...
          <li>
            <a href="https://www.linkedin.com/in/muhamed-ahmed-7b5ba41b1/" rel="noopener" target="_blank" title='LinkedIn'>
              <svg version="1.1" width="1792" height="1792" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                <path d="M477 625v991h-330v-991h330zm21-306q1 73-50.5 122t-135.5 49h-2q-82 0-132-49t-50-122q0-74 51.5-122.5t134.5-48.5 133 48.5 51 122.5zm1166 729v568h-329v-530q0-105-40.5-164.5t-126.5-59.5q-63 0-105.5 34.5t-63.5 85.5q-11 30-11 81v553h-329q2-399 2-647t-1-296l-1-48h329v144h-2q20-32 41-56t56.5-52 87-43.5 114.5-15.5q171 0 275 113.5t104 332.5z"></path>
              </svg>
            </a>
